        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white mb-3">
            <div class="container">
                <a href="/assets/adminlte/index3.html" class="navbar-brand">
                    <img src="/assets/adminlte/dist/img/AdminLTELogo.png" alt="Love Karomani" class="brand-image img-square elevation-3" style="opacity: .8">
                    <span class="brand-text font-weight-light">Akmal Gilang</span>
                </a>
